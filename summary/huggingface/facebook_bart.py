...
tokenizer = BartTokenizer.from_pretrained(r"D:\discourse_code\code\model\facebook")
model = BartForConditionalGeneration.from_pretrained(r"D:\discourse_code\code\model\facebook",output_past=True)
